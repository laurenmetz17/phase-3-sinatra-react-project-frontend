    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/add" element={<StoreForm stores={stores} setStores={setStores} inventory={inventory} setInventory={setInventory} setTotalInventory={setTotalInventory} totalInventory={totalInventory}/>}/>
        </Routes>
      </BrowserRouter>
    </div>
  );
